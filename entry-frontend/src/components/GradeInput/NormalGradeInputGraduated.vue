    ...
    <div class="grade-input-cover">
      ...
      <table class="grade-input-table" ref="grade-table">
        ...
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(koreanScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`korean-third-second-${k}`"
                   v-model="koreanScores[5].score"
                   :checked="koreanScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`korean-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, koreanScores[5])"
                   :class="complete(koreanScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!koreanScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="korean-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, koreanScores[5])"
                   :class="discomplete(koreanScores[5].score)"
            >X</label>
          </td>
        </tr>
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(societyScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`society-third-second-${k}`"
                   v-model="societyScores[5].score"
                   :checked="societyScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`society-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, societyScores[5])"
                   :class="complete(societyScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!societyScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="society-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, societyScores[5])"
                   :class="discomplete(societyScores[5].score)"
            >X</label>
          </td>
        </tr>
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(historyScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`history-third-second-${k}`"
                   v-model="historyScores[5].score"
                   :checked="historyScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`history-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, historyScores[5])"
                   :class="complete(historyScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!historyScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="history-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, historyScores[5])"
                   :class="discomplete(historyScores[5].score)"
            >X</label>
          </td>
        </tr>
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(mathScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`math-third-second-${k}`"
                   v-model="mathScores[5].score"
                   :checked="mathScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`math-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, mathScores[5])"
                   :class="complete(mathScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!mathScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="math-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, mathScores[5])"
                   :class="discomplete(mathScores[5].score)"
            >X</label>
          </td>
        </tr>
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(scienceScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`science-third-second-${k}`"
                   v-model="scienceScores[5].score"
                   :checked="scienceScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`science-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, scienceScores[5])"
                   :class="complete(scienceScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!scienceScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="science-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, scienceScores[5])"
                   :class="discomplete(scienceScores[5].score)"
            >X</label>
          </td>
        </tr>
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(techAndHomeScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`tech-home-third-second-${k}`"
                   v-model="techAndHomeScores[5].score"
                   :checked="techAndHomeScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`tech-home-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, techAndHomeScores[5])"
                   :class="complete(techAndHomeScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!techAndHomeScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="tech-home-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, techAndHomeScores[5])"
                   :class="discomplete(techAndHomeScores[5].score)"
            >X</label>
          </td>
        </tr>
        <tr class="grade-input-table__row">
          ...
          <td :class="changeBackground(englishScores[5].score)">
            <input type="radio"
                   v-for="k in scores"
                   :key="k"
                   :value="k.toUpperCase()"
                   :id="`english-third-second-${k}`"
                   v-model="englishScores[5].score"
                   :checked="englishScores[5].decided"
            >
            <label v-for="(k, index) in scores"
                   :key="index"
                   :for="`english-third-second-${k}`"
                   class="input-grade-label"
                   @click="changeDecided($event, englishScores[5])"
                   :class="complete(englishScores[5].score, k.toUpperCase())"
            >
              {{ k.toUpperCase() }}
            </label>
            <div class="button-side-line" v-show="!englishScores[5].score"></div>
            <input type="radio"
                   value="X"
            ...
            <label for="english-third-second-null"
                   class="input-grade-label"
                   @click="changeDecided($event, englishScores[5])"
                   :class="discomplete(englishScores[5].score)"
            >X</label>
          </td>
        </tr>
      </table>
